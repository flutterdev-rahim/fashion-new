...
import 'package:bpp_shop/view_model/islamic/http_slider.dart';
 ...
 //  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      //                   height: 120,
      //                   margin: EdgeInsets.symmetric(vertical: 10),
      //                   child: slider![itemIndex].sliderImg != null
      //                       ? Image.network(
      //                           'https://bppshops.com/${slider![itemIndex].sliderImg}',
      //                           fit: BoxFit.fill,
      //                         )
      //                       : Image.network(
      //                           'https://st3.depositphotos.com/23594922/31822/v/600/depositphotos_318221368-stock-illustration-missing-picture-page-for-website.jpg')),
  ...
  //
  // getSliderData() async {
  //   final value = await _httpRequests.httpGetRequest(
  //       suffixUrl: _httpRequests.islamicHomepage,
  //       returnValue: _httpRequests.returnSliders);
  //   setState(() {
  //     slider = value;
  //   });
  // }
