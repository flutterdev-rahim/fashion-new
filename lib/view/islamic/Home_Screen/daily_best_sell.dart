...
import 'package:bpp_shop/view_model/islamic/http_daily_best_sell.dart';
          ...
          if (snapshot.hasData){
            ...
            return  Column(
              children: [
                ...
                Container(
                  height:get.length<3?MediaQuery.of(context).size.width/1.5+10:get.length>3?(MediaQuery.of(context).size.width/1.5+10)*2:0,
