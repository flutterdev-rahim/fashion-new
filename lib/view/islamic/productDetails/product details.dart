                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text("${args.size}",style: TextStyle(color: Colors.white),),
                      ),
                    ),
                  ],
                ),
...
width:250,
                ...
                Row(
                  ...
                  children: const [
                    ...
                    Image(image: AssetImage("assets/icons/facebook.webp"), fit: BoxFit.cover,height: 25,),
                    SizedBox(
                      width: 15,
                    ),
                    Image(image: AssetImage("assets/icons/youtube.webp"),fit: BoxFit.cover,height: 25,),
                    SizedBox(
                      width: 15,
                    ),
                    Image(image: AssetImage("assets/icons/twitter.webp"), fit: BoxFit.cover,height: 25,),
                    SizedBox(
                      width: 15,
                    ),
                    Image(image: AssetImage("assets/icons/linkedin.webp"), fit: BoxFit.cover,height: 25,),
                    SizedBox(
                      width: 15,
                    ),
                  ],
                ...
                Container(
                    ...
                    height: 350,
                    child: TabBarScreen(details: args.productDetail!,video: args.video,)),
