...
class CartScreen extends StatefulWidget {
  ...
  final int ?qty;
  CartScreen({this.id, this.productId, this.price, this.quantity, this.name,this.delivery=50.0,this.qty});
        ...
        children: [
          ...
          Card(
            ...
            ListTile(
              ...
              trailing: InkWell(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=>MyCoupons()));
                },
                child: Container(
                    height:40,
                    width:70,
            ...
            child: Column(children: [Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  AnimatedFlipCounter(
                    ...
                    wholeDigits: 1,
                    fractionDigits: 1,
                    textStyle: TextStyle(fontSize: 18, color:Color(0xFFE37D4E)),
                  ),
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Delivery Charge',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 18)),
                    Text('${cart.subAmount!=0.0?widget.delivery:0.0}',style: TextStyle(fontSize: 18,color: Color(0xFFE37D4E)),)
                  ],
                ),
              ),
          ...
          Container(
            ...
            child:ElevatedButton(
                ...
                onPressed: cart.items.isNotEmpty?()async{
                  ...
                  token != "null"
                      ...
                      : Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => EmailLogin(from: "cart",)));
                }:(){
                  ...
                  MaterialButton(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Icon(
                          Icons.home,
                          color:Color(0xFFE37D4E), //currentTab == 0 ? Colors.amber,//: Colors.grey,
                        ),
                        Text(
                          'Home',
                          style: TextStyle(
