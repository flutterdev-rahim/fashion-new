...
import 'package:bpp_shop/view_model/grocery/http_deal_of_day_grocery.dart';
...
class DealsOfTheDaySeeAll extends StatelessWidget {
  const DealsOfTheDaySeeAll({Key? key}) : super(key: key);
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text('৳ ${double.tryParse(get[i].discountPrice!)?.toStringAsFixed(1)}',
