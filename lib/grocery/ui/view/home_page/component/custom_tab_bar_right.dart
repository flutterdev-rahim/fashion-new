...
class CustomTabBarRight extends StatefulWidget {
  CustomTabBarRight({Key? key,this.tab1,this.tab2,}) : super(key: key);

  String? tab1;
  String? tab2;

  @override
  _CustomTabBarRightState createState() => _CustomTabBarRightState(tab1: tab1!,tab2:tab2!);
}

class _CustomTabBarRightState extends State<CustomTabBarRight>
    with SingleTickerProviderStateMixin {

  _CustomTabBarRightState({this.tab1,this.tab2,});
