...
import 'package:bpp_shop/grocery/clip.dart';
...
import 'package:bpp_shop/view_model/grocery/http_daily_best_sell.dart';
...
class DailyBestSellSeeAll extends StatelessWidget {
  const DailyBestSellSeeAll({Key? key}) : super(key: key);
  ...
  //  final bundleOffersModel = Provider.of<BundleOffersModel>(context);
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Daily Best Sells",style: TextStyle(color: Colors.black),),
        centerTitle: true,
      ...
      body: FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            if (snapshot.hasData) {
              List<GDailyBestSales> get = snapshot.data ??
                  <GDailyBestSales>[];
              return Container(
                  height: MediaQuery
                      .of(context)
                        ...
                        child: GestureDetector(
                          onTap: () {
                            productDetailData.setProductDetailData(
                              ...
                              //item.productName,
                              productImageUrl: "https://bppshops.com/${get[index].productThambnail}",
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                              image:get[index].productThambnail!=null?NetworkImage("https://bppshops.com/${get[index].productThambnail}"):
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            child: Text("${get[index].sellingPrice}",
